...
def print_question(die_1_value, die_2_value, question_type):
    ...
    if question_type == "sum":
        print("You rolled a {die_1_value} and a {die_2_value}... What is the sum of {die_1_value} and {die_2_value}?")
    elif question_type == "difference":
        print("You rolled a {die_1_value} and a {die_2_value}... What is the difference between {die_1_value} and {die_2_value}?")
...
def print_correct_answer(die_1_value, die_2_value, question_type):
    ...
    if question_type == "sum":
        correct_answer = die_1_value + die_2_value
        print("No! The sum of {die_1_value} and {die_2_value} is {correct_answer}!")
    elif question_type == "difference":
        correct_answer = abs(die_1_value - die_2_value)
        print("No! The difference between {die_1_value} and {die_2_value} is {correct_answer}!")
